...
label meetTheTeam:
    ...
    # intro text. idk how to do this
    # Normington Association of Heroes (Outside)
    #                  09:00 AM
    ...
    scene Normington Association of Heroes Headquarters
    # Normington Association of Heroes (Inside)
    #                   09:00 AM
