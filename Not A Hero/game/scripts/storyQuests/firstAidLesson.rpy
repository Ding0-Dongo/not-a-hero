label firstAidLesson:
    if energy < 2:
        ...
        if firstAidDone == True:
            ...
            "(For Ellis's efforts, the commission awards him $10.)"
            ...
            if deliveryRunDone == True:
                ...
                j "But that must've been so exciting! What did you two do together?"

                hide ellisThinking
                show ellisShy at ellis_std:
                    xalign 0.2
                
                e "Just... um... just delivered some packages, that's all. It wasn't {i}that{/i} cool or anything..."
            ...
            menu:
                "Sure":
                    ...
                    j "You know, I'm pretty proud that you're trying. It's not easy, is it?"
